// ISO 3166-1 alpha-2 country list. Used for validation and the AI suggest flow.
export const COUNTRIES = [
  ...
  { code: 'AU', name: 'Australia' }, { code: 'AZ', name: 'Azerbaijan' },
  ...
  { code: 'FM', name: 'Micronesia' }, { code: 'FR', name: 'France' },
...
export function normalizeCountryCode(code) {
  ...
  return codeSet.has(upper) ? upper : null;
}
...
export function filterValidCodes(codes) {
